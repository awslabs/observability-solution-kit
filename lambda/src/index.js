...
import { middlewares, interceptor } from './service/middlewares.js';
import TenantLogger from './service/logger.js';

export { TenantLogger as Logger, middlewares, interceptor };
